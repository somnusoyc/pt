  ...
  const scienceTopics = [
    {
        topicId: "04",
        isArticle: true, 
        title: "别只知道补钙，<br>大脑发育其实更需要这种“酸”。",
        introImage: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=1000&auto=format&fit=crop",
        introText: `许多家长忽略了神经系统的营养补充，燕窝酸才是关键。它直接参与脑部结构构建，比单一补钙更能支持孩子的全面成长。`,
        buttonText: "阅读文章"
    },
    {
        topicId: "01",
        title: "01 促进脑突触生长",
        introImage: "https://img.freepik.com/premium-photo/abstract-brain-neural-network-set-symbolizing-neurons-connection-science-brands-concept-science-neural-network-brain-abstract-technology_918839-28211.jpg",
        introText: `补充燕窝酸（SA）有助于增加脑部神经节苷脂水平。动物实验表明，燕窝酸能促进神经细胞的分化与再生，增强神经突触之间的信号传导，从而在迷宫测试中表现出更快的反应速度。`,
        source: '原文: Wang B et al. Am J Clin Nutr. 2007.'
    },
    {
        topicId: "02",
        title: "02 构建免疫防线",
        introImage: "https://img.freepik.com/free-photo/top-view-pills-tray-with-medical-mask-surgical-glove_23-2148533449.jpg?semt=ais_hybrid&w=740&q=80",
        introText: `燕窝酸是许多致病菌和病毒的“诱饵”。它能与侵入人体的流感病毒结合，阻止它们吸附在呼吸道黏膜细胞上，从而起到阻断感染的作用，帮助儿童抵御换季风险。`,
        source: '原文: Varki A et al. Glycobiology. 2008.'
    },
    {
        topicId: "03",
        title: "03 提升专注与认知",
        introImage: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?q=80&w=1000&auto=format&fit=crop",
        introText: `燕窝酸参与神经细胞膜的稳定与信息传递。充足的燕窝酸供应有助于缓解大脑疲劳，维持长时间的高效专注。临床观察发现，血液中唾液酸水平较高的儿童在认知评估中得分往往更高。`,
        source: '原文: Schnaar RL et al. Physiol Rev. 2014.'
    }
  ];
        ...
        <div className="bg-[#f2f2f2] font-sans text-gray-800 w-full max-w-md relative shadow-2xl overflow-hidden md:rounded-[2rem] border-x border-gray-100 pb-8 mt-11 md:mt-0">
            ...
            <div className="relative h-72 w-full overflow-hidden">
                <div className="absolute inset-0">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-b from-blue-900/50 to-slate-900/90"></div>
                </div>
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-white pt-4">
                    <div className="mb-12 transform translate-y-16 flex flex-col items-center">
                        <h1 className="text-3xl font-bold tracking-wider mb-1">儿童燕窝酸</h1>
                        <p className="text-sm font-light tracking-widest opacity-90">Kids Sialic Acid (SA)</p>
                    </div>
                    
                    <div className="w-48 h-48 flex items-center justify-center drop-shadow-2xl -mt-4">
                        <img 
                            src="https://pbs.twimg.com/media/G8SON71aIAEy0Ea?format=png&name=900x900" 
                            alt="N-乙酰神经氨酸" 
            ...
            <div className="px-6 pt-8 pb-5 relative bg-white rounded-b-[2rem] z-20">
                <p className="text-[20px] leading-9 text-gray-700 font-normal text-justify tracking-wide">
                    大脑发育的“加速器”。N-乙酰神经氨酸（燕窝酸）是神经节苷脂的核心成分，能促进神经突触连接，让孩子反应更快、记忆更牢。
                </p>
            </div>
            ...
            <div className="bg-[#f2f2f2] pt-16 pb-6 -mt-8 relative z-10">
                ...
                <div className="px-6 mb-10">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <NeedCard 
                            img="https://img.freepik.com/free-photo/child-bored-home-while-being-tutored_23-2148524540.jpg?uid=R123194390&ga=GA1.1.681520704.1714354708&semt=ais_hybrid&w=740&q=80" 
                            text="记性差 背书慢" 
                        />
                        <NeedCard 
                            img="https://cdn.pixabay.com/photo/2020/05/15/18/41/baby-5174649_1280.jpg" 
                            text="体质弱 易生病" 
                        />
                        <NeedCard 
                            img="https://cdn.pixabay.com/photo/2014/07/11/22/05/baby-390555_640.jpg" 
                            text="处于黄金期" 
                        />
                        <NeedCard 
                            img="https://p2.itc.cn/images01/20230102/2c1c02ba50b24f3bbfe85cb4f0c1a964.jpeg" 
                            text="走神多 反应慢" 
                        />
                    </div>
                </div>
                ...
                <div className="mb-12">
                    <div className="px-6 mb-6">
                        <h2 className="text-xl font-normal text-gray-900 mb-1">关于燕窝酸的相关研究</h2>
                        <p className="text-xs text-gray-500 uppercase tracking-wide mb-2">Scientific Research on Sialic Acid</p>
                    </div>
                ...
                <div className="px-6 mb-12">
                    ...
                    <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100">
                        ...
                        <div className="grid grid-cols-[44px_1fr_1fr] gap-1 text-sm">
                            <ComparisonRow 
                                title="工艺" 
                                leftTitle="生物发酵技术" leftText="专利发酵提取，活性单一，直接获取高纯度 SA。" 
                                rightTitle="传统炖煮/化学" rightText="炖煮提取效率低，化学提取易残留，活性易流失。" 
                                round="top"
                            />
                            <ComparisonRow 
                                title="纯度" 
                                leftTitle="98% 极致高纯" leftText="0 亚硝酸盐，0 杂质，给孩子制药级的纯净营养。" 
                                rightTitle="纯度参差不齐" rightText="原料常含杂质，缺乏纯度证明，安全性存疑。" 
                            />
                            <ComparisonRow 
                                title="含量" 
                                leftTitle="100mg 足量" leftText="科学配比，1 包含量 ≈ 顶级干燕窝 1 盏的营养。" 
                                rightTitle="含量虚标/不足" rightText="含量往往仅为 20-30mg，需大量食用才有效。" 
                                round="bottom"
                            />
                        </div>
                            ...
                            <div className="flex items-center justify-between px-2">
                                <div className="flex flex-col items-center w-[35%] relative group">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <span className="text-[10px] text-gray-500 uppercase mt-1 block">NutriPacks SA</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col w-[42%] justify-center">
                                    <div className="flex items-center gap-3">
                                        <div className="w-14 h-14 rounded-full bg-orange-50 border border-orange-100 flex items-center justify-center overflow-hidden shrink-0 shadow-sm">
                                            <img 
                                                src="https://pic5.sucaisucai.com/09/24/09324205_2.jpg" 
                                                alt="Bird Nest" 
                                                className="w-full h-full object-cover scale-110"
                                            />
                                        </div>
                                        <div className="flex flex-col">
                                            <span className="text-xl font-bold text-gray-900 leading-none">1盏</span>
                                            <span className="text-xs text-gray-500 mt-1">特级干燕窝</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="px-6 mb-12">
                    <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-5">
                            <SpecRow label="适宜人群" text="3岁及以上儿童、青少年，尤其是处于生长发育黄金期、学业繁重、需要补充脑营养或体质较弱的人群。" />
                            <SpecRow label="不适宜人群" text="3岁以下婴幼儿请遵医嘱；对此类成分过敏者慎用。" />
                            <SpecRow label="规格" text="28 袋/盒 （28天周期装）" />
                            <SpecRow label="配方">
                                ...
                                <div className="flex justify-between w-full max-w-[200px]">
                                    <span>牛磺酸</span>
                                    <span className="font-bold text-gray-800">30mg/袋</span>
                                </div>
                            </SpecRow>
                            <SpecRow label="辅料" text="赤藓糖醇、水蜜桃果粉（不含人工色素、防腐剂）" />
                            <SpecRow label="保质期" text="24 个月" />
                            <SpecRow label="储存条件" text="请置于阴凉干燥处，避免阳光直射。开启后请尽快食用。" />
                            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                                ...
                                <ul className="text-sm text-gray-600 leading-relaxed font-normal list-disc pl-4 space-y-1">
                                    <li>本品为膳食营养补充剂，不能代替药物治疗疾病；</li>
                                    <li>不宜超过推荐量或与同类营养素同时食用；</li>
                                    <li>如发现包装破损或胀袋，请勿食用；</li>
                                    <li>请放置于儿童不易触及处，以免误食。</li>
                                </ul>
                            </div>
                        </div>
